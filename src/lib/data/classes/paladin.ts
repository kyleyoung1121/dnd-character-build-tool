...
const proficienciesPrompt: FeaturePrompt = {
	...
	description: {
		blocks: [
			...
			{ type: 'text', text: 'Skills: Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion' },
		]
	},
	featureOptions: {
...
const fightingStylePrompt: FeaturePrompt = {
	...
	description: {
		blocks: [
			{ type: 'text', text: 'Choose a fighting style to enhance your combat ability.' },
		]
	},
	featureOptions: {
			...
			},
			{
				...
				nestedPrompts: [
					...
					},
					{
						...
						description: {
							blocks: [
								{ type: 'text', text: 'As a bonus action, you can utter a vow of enmity against a creature you can see within 10 feet of you, using your Channel Divinity. You gain advantage on attack rolls against the creature for 1 minute or until it drops to 0 hit points or falls unconscious.' },
							]
						},
						source: 'paladin.oath_vengeance',
						effects: [
