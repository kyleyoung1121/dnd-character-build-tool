...
export const knight: BackgroundData = {
	...
	description: 'You understand wealth, power, and privilege as a knight who has sworn fealty to a sovereign.',
	flavorDescription: 'A knighthood is among the lowest noble titles in most societies, but it can be a path to higher status. If you wish to be a knight, choose the Retainers feature instead of the Position of Privilege feature. One of your commoner retainers is replaced by a noble who serves as your squire, aiding you in exchange for training on his or her own path to knighthood. Your two remaining retainers might include a groom to care for your horse and a servant to polish your armor (and even help you put it on).',
	...
	backgroundFeatures: [
		...
		},
		{
			name: 'Retainers',
			id: 'knight_feature',
			description: 'You have three retainers: a noble squire training for knighthood, and two others such as a groom and servant who perform mundane tasks.',
			source: 'background:Knight',
			effects: [
				{
					target: 'features',
