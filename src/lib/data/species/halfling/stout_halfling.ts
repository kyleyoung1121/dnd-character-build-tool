...
const abilityScoreChoicePrompt: FeaturePrompt = {
	...
	description: {
		blocks: [
			{ type: 'text', text: 'Your Dexterity score increases by 2, and your Constitution score increases by 1.' },
		]
	},
...
export const stoutHalfling: SpeciesData = {
	...
	speciesFeatures: [
		...
		},
		{
			...
			description: {
				blocks: [
					{ type: 'text', text: 'You have advantage on saving throws against poison, and you have resistance against poison damage.' },
				]
			},
			source: 'stout_halfling',
