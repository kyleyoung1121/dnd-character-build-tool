...
export const guildArtisan: BackgroundData = {
	...
	flavorDescription: 'You are a member of an artisan\'s guild, skilled in a particular field and closely associated with other artisans. You are a well-established part of the mercantile world, freed by talent and wealth from the constraints of a feudal social order. You learned your skills as an apprentice to a master artisan, under the sponsorship of your guild, until you became a master in your own right.',
	...
	backgroundFeatures: [
		...
		},
		{
			...
			description: 'You start with artisan\'s tools, letter of introduction from your guild, traveler\'s clothes, and 15 gp.',
			source: 'background:Guild Artisan',
			effects: [
				{
					target: 'inventory',
		...
		},
		{
			...
			description: 'Your guild membership provides lodging, food, and funeral arrangements. Guildhalls offer meeting places for potential patrons and allies.',
			source: 'background:Guild Artisan',
			effects: [
				{
					target: 'features',
