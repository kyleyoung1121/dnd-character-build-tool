...
export const folkHero: BackgroundData = {
	...
	flavorDescription:
		'Already the people of your home village regard you as their champion, and your destiny calls you to stand against the tyrants and monsters that threaten the common folk everywhere. You might have saved your village from a rampaging owlbear, or you might have stood up to the local tyrant.',
	...
	startingEquipment: {
		fixed: ['Shovel', 'Iron pot', 'Common clothes', 'Belt pouch with 10 gp'],
		choices: [
			{
