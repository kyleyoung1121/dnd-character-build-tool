...
export const sailor: BackgroundData = {
	...
	description: 'You sailed on a seagoing vessel for years, facing down mighty storms, monsters of the deep, and those who wanted to sink your craft.',
	flavorDescription: 'You sailed on a seagoing vessel for years. In that time, you faced down mighty storms, monsters of the deep, and those who wanted to sink your craft to the bottomless depths. Your first love is the distant line of the horizon, but the time has come to try your hand at something new.',
	...
	backgroundFeatures: [
		...
		},
		{
			name: 'Ship\'s Passage',
			id: 'sailor_feature',
			description: 'You can secure free passage on sailing ships for yourself and companions, though you\'re expected to assist the crew during the voyage.',
			source: 'background:Sailor',
			effects: [
				{
					target: 'features',
