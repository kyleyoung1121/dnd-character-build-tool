...
export const cantrips: Spell[] = [
	...
	},
	{
		...
		description:
			"You create up to four glowing orbs that hover in the air for the duration. You can also combine the four lights into one glowing vaguely humanoid form of Medium size. Each light sheds dim light in a 10 foot radius. \nAs a bonus action on your turn, you can move the lights up to 60 feet to a new spot within range.",
	...
	},
	{
		...
		duration: '1 minute',
		description:
			"You create a sound or an image of an object. \nIf you create a sound, its volume can range from a whisper to a scream.\nIf you create an image of an object, it must be no larger than a 5 foot cube. Physical interaction with the image reveals it to be an illusion, because things can pass through it. \nCreatures can make an Investigation check (against your spell save DC) to determine that your illusion is not real.",
		classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard'],
		tags: ['Utility']
	},
	{
	...
	},
	{
		...
		description:
			'You manifest a minor wonder, a sign of supernatural power. You create one of the following magical effects:\n-Your voice booms up to three times as loud as normal for 1 minute.\n-You cause flames to flicker, brighten, dim, or change color for 1 minute.\n-You cause harmless tremors in the ground for 1 minute.\n-You create an sound that comes from a point of your choice, such as a rumble of thunder, the cry of a raven, or ominous whispers.\n-You instantaneously cause an unlocked door or window to fly open or slam shut.\n-You alter the appearance of your eyes for 1 minute.\nIf you cast this spell multiple times, you can have up to three of its effects active.',
		classes: ['Cleric'],
		tags: ['Utility']
	},
	{
...
export const firstLevel: Spell[] = [
	{
		...
		description:
			...
			"You set an alarm against unwanted intrusion. Choose a door, a window, or an area. Until the spell ends, an alarm alerts you whenever a creature touches/enters the warded area. When you cast the spell, you can designate creatures that won't set off the alarm. You also choose whether the alarm is mental or audible.\nA mental alarm alerts you with a ping in your mind if you are within 1 mile of the warded area. This ping awakens you if you are sleeping.\nAn audible alarm produces the sound of a hand bell for 10 seconds within 60 feet.",
	...
	},
	{
		...
		duration: '1 round',
		description:
			'A dazzling array of flashing, colored light springs from your hand. Roll 6d10; the total is how many hit points of creatures this spell can affect. Creatures in a 15 foot cone originating from you are affected in ascending order of their current hit points.\nStarting with the creature that has the lowest current hit points, each creature affected by this spell is blinded until the end of your next turn. Subtract each creature’s hit points from the total before moving on to the creature with the next lowest hit points.',
		higherLevel:
	...
	},
	{
		...
		description:
			...
			"You speak a one-word command to a creature you can see within range. The target must succeed on a Wisdom saving throw or follow the command on its next turn. The spell has no effect if the target cannot understand you, or if your command is directly harmful to it.\n[APPROACH]. The target moves toward you, ending its turn if it moves within 5 feet of you.\n[DROP]. The target drops whatever it is holding and then ends its turn.\n[FLEE]. The target spends its turn running away.\n[GROVEL]. The target falls prone and then ends its turn.\n[HALT]. The target doesn't move and takes no actions.",
		higherLevel:
	...
	},
	{
		...
		description:
			...
			"You magically alter how you appear (including your body, clothes, and weapons). Your magical disguise must be close in shape and size to your true form. \nThis new appearance is only an illusion. Physical inspection will reveal your disguise as an illusion. \nTo discern that you are disguised, a creature can use its action to inspect your appearance and must succeed on an Intelligence (Investigation) check against your spell save DC.",
		classes: ['Bard', 'Sorcerer', 'Wizard'],
		tags: ['Utility']
	},
	{
		...
		duration: 'Instantaneous',
		description:
			'You whisper a discordant melody that only one creature of your choice within range can hear, wracking it with terrible pain. The target must make a Wisdom saving throw. On a failed save, it takes 3d6 psychic damage and must immediately use its reaction to run away from you. The creature doesn’t move into obviously dangerous ground, such as a fire or a pit. On a successful save, the target takes half as much damage and doesn’t have to move away. A deafened creature automatically succeeds on the save.',
		higherLevel:
			'When you cast this spell using a 2nd level spell slot, the damage increases by 1d6.',
		classes: ['Bard'],
		tags: ['SpellSave', 'Debuff']
	...
	},
	{
		...
		description:
			...
			'The next time you hit a creature with a weapon attack, a writhing mass of thorny vines appears at the point of impact, and the target must succeed on a Strength saving throw or be restrained. Large creatures have advantage. \nWhile restrained by this spell, the target takes 1d6 piercing damage at the start of each of its turns. A restrained creature can be freed with a Strength check against your spell save DC.',
		higherLevel:
			'When you cast this spell using a 2nd level spell slot, the damage increases by 1d6.',
		classes: ['Ranger'],
		tags: ['SpellSave', 'Debuff']
	},
	{
		...
		description:
			...
			'Grasping weeds and vines sprout from the ground in a 20 foot square starting from a point within range. The area becomes difficult terrain.\nA creature in the area when you cast the spell must succeed on a Strength saving throw or be restrained by the entangling plants until the spell ends. A restrained creature can be freed with a Strength check against your spell save DC.',
		classes: ['Druid'],
	...
	},
	{
		...
		description:
			...
			"Each object in a 20 foot cube is outlined in blue, green, or violet light. Any creature in the area when the spell is cast is also outlined in light if it fails a Dexterity saving throw. \nAny attack roll against an affected creature or object has advantage if the attacker can see it, and the affected creature or object can't benefit from being invisible.",
		classes: ['Bard', 'Druid'],
		tags: ['SpellSave', 'AreaOfEffect', 'Debuff']
	},
	{
	...
	},
	{
		...
		description:
			...
			"You gain the service of a familiar, a spirit that takes an animal form you choose.\nYour familiar acts independently of you, but it always obeys your commands. In combat, it acts immediately after your turn. A familiar can't attack, but it can take other actions, such as Help.\nAs an action, you can use your familiar's senses. During this time, you are deaf and blind with regard to your own senses.\nWhen you cast a spell with a range of touch, your familiar can deliver the spell as if it had cast the spell.",
	...
	},
	{
		...
		duration: 'Concentration, up to 1 minute',
		description:
			'The next time you hit a creature with a ranged weapon attack, this spell creates a rain of thorns that assault the target. In addition to the normal damage, the target and any creature within 5 feet of it must make a Dexterity saving throw. A creature takes 1d10 piercing damage on a failed save, or half as much damage on a successful one.',
		higherLevel:
	...
	},
	{
		...
		description:
			...
			'You place a curse on a creature that you can see within range. You deal an extra 1d6 necrotic damage to the target whenever you hit it with an attack. Also, the target gains disadvantage on ability scores made with an ability of your choice.\nIf the target drops to 0 hit points, you can use a bonus action on a subsequent turn of yours to curse a new creature.',
		classes: ['Warlock'],
		tags: ['Debuff']
	},
	{
		...
		duration: 'Concentration, up to 1 hour',
		description:
			'You choose a creature you can see within range and mystically mark it as your quarry. You deal an extra 1d6 damage to the target whenever you hit it with a weapon attack, and you have advantage on any Perception or Survival check you make to find it. If the target drops to 0 hit points, you can use a bonus action on a subsequent turn of yours to mark a new creature.',
		classes: ['Ranger'],
		tags: ['Debuff']
	},
	{
		...
		description:
			...
			'You choose one object that you must touch throughout the casting of the spell. If it is a magic item or some other magic-imbued object, you learn its properties and how many charges it has, if any. You learn whether any spells are affecting the item and what they are.\nIf you instead touch a creature throughout the casting, you learn what spells, if any, are currently affecting it.',
		classes: ['Bard', 'Wizard'],
		ritual: true,
		tags: ['Utility']
	},
	{
		...
		description:
			...
			'You scribble a potent illusion on paper, parchment, or some other surface.\nThe writing\'s message appears clear to you and any creatures you designate when you cast the spell. To all others, the writing appears in an unintelligible script, or as another message or your choice.\nA creature with truesight can read the hidden message.',
	...
	},
	{
		...
		duration: 'Instantaneous',
		description:
			'You create three glowing darts of magical force. Each dart automatically hits a creature of your choice that you can see within range. A dart deals 1d4 + 1 force damage to its target. The darts all strike simultaneously, and you can direct them to hit one creature or several.',
		higherLevel:
	...
	},
	{
		...
		description:
			...
			"Until the spell ends, one willing creature you touch is protected against certain types of creatures: aberrations, celestials, elementals, fey, fiends, and undead.\nCreatures of those types have disadvantage on attack rolls against the target. The target also can't be charmed, frightened, or possessed by them. If the target is already under such an effect, it gains advantage on saves to break free.",
	...
	},
	{
		...
		description:
			...
			"You ward a creature within range against attack. A creature must succeed a Wisdom saving through to target the warded creature with an attack or a harmful spell. On a failed save, the creature must choose a new target or lose the attack or spell. This spell doesn't protect the warded creature from area effects, such as the explosion of a fireball.\nIf the warded creature makes an attack or casts a spell that affects an enemy, this spell ends.",
		classes: ['Cleric'],
		tags: ['Buff']
	},
	{
		...
		description:
			...
			'The next time you hit a creature with a melee weapon attack, your weapon flares with white-hot intensity, and the attack deals an extra 1d6 fire damage to the target and causes the target to ignite in flames. At the start of each of its turns until the spell ends, the target must make a Constitution saving throw. On a failed save, it takes 1d6 fire damage. On a successful save, the spell ends. The spell also ends if the target uses an action to put out the flames.',
		higherLevel:
	...
	},
	{
		...
		description:
			...
			"You create the image of an object, a creature, or some other visible phenomenon that is no larger than a 15 foot cube. The image appears at a spot within range and lasts for the duration. The image is purely visual; it isn't accompanied by sound, smell, or other sensory effects.\nYou can use your action to cause the image to move within range.\nA creature can use its action to make a Investigation check to discern the illusion for what it is, allowing them to see through it.",
		classes: ['Bard', 'Sorcerer', 'Wizard'],
		tags: ['Utility']
	},
	{
		...
		description:
			...
			'This spell sends creatures into a magical slumber. Roll 5d8; the total is how many hit points of creatures this spell can affect. Creatures within 20 feet of a point you choose are affected in ascending order of their hit points.\nStarting with the creature that has the lowest current hit points, each creature affected by this spell falls unconscious until the spell ends, the sleeper takes damage, or someone uses an action to shake the sleeper awake. Subtract each creature’s hit points from the total before moving on to the creature with the next lowest hit points.',
		higherLevel:
	...
	},
	{
		...
		description:
			...
			'This spell creates a 3ft. circular plane of force, that floats 3 feet above the ground. The disk can hold up to 500 pounds.\nThe disk is immobile while you are within 20 feet of it, but follows you so that it remains within 20 feet of you. It can move across uneven terrain, but it can’t cross an elevation change of 10 feet or more.',
		classes: ['Wizard'],
		ritual: true,
		tags: ['Utility'],
		isRareUse: true
	...
	},
	{
		...
		duration: 'Instantaneous',
		description:
			"A wave of thunderous force sweeps out from you. Each creature in a 15 foot cube originating from you must make a Constitution saving throw. On a failed save, a creature takes 2d8 thunder damage and is pushed 10 feet away from you. On a successful save, the creature takes half as much damage and isn't pushed.\nIn addition, unsecured objects are automatically pushed 10 feet away from you, and the spell emits a thunderous boom audible out to 300 feet.",
		higherLevel:
			'When you cast this spell using a 2nd level spell slot, the damage increases by 1d8.',
	...
	},
	{
		...
		description:
			...
			"This spell creates an invisible, mindless, shapeless, Medium force that performs simple tasks at your command until the spell ends. It has AC 10, 1 hit point, and a Strength of 2, and it can't attack.\nOnce on each of your turns as a bonus action, you can mentally command the servant to move up to 15 feet and interact with an object. The servant can perform simple tasks, like fetching, cleaning, mending, folding, and serving food.",
		classes: ['Bard', 'Warlock', 'Wizard'],
		ritual: true,
		tags: ['Utility'],
		isRareUse: true
...
export const secondLevel: Spell[] = [
	...
	},
	{
		...
		description:
			...
			"You assume a different form. You gain one of the following adaptations, and can switch your choice with an action.\n[Aquatic Adaptation]. You sprout gills and grow webbing between your fingers. You can breathe underwater and gain a swimming speed equal to your walking speed.\n[Change Appearance]. You transform your appearance. You can adjust your height, facial features, sound of your voice, and other characteristics. \n[Natural Weapons]. You grow claws, horns, or a different natural weapon of your choice. Your unarmed strikes deal 1d6 bludgeoning, piercing, or slashing damage. Finally, the natural weapon is magic and you have a +1 bonus to the attack and damage rolls you make using it.",
		classes: ['Sorcerer', 'Wizard'],
		tags: ['Buff', 'Utility']
	},
	{
		...
		description:
			...
			"You magically enchant an animal to deliver a message for you. Choose a nearby Tiny beast, such as a squirrel, a blue jay, or a bat. You specifiy a location, a recipient, and a message of 25 words or less. The beast attempts to travel to the intended destination to find the specified recipient. If successful, it relays your message, magically reproducing your voice. The beast can travel 25 miles within the spell\'s 24 hour duration, or 50 miles if the beast can fly.",
		classes: ['Bard', 'Druid', 'Ranger'],
		ritual: true,
		tags: ['Utility'],
		isRareUse: true
	},
	{
		...
		description:
			...
			'You touch a closed door, window, gate, chest, or other entryway, and it becomes magically locked for the duration. You and the creatures you designate when you cast this spell can open the object normally. Otherwise, it is impassable until it is broken or the spell is dispelled or suppressed. \nWhile affected by this spell, the object is more difficult to break or force open; the DC to break it or pick any locks on it increases by 10.',
		classes: ['Wizard'],
		tags: ['Utility'],
		isRareUse: true
	},
	{
		...
		description:
			...
			"By laying out ornate cards, or employing some other divining tool, you receive an omen from an otherworldly entity about the results of a specific course of action that you plan to take within the next 30 minutes. The DM chooses from the following possible omens:\n• Weal: good results\n• Woe: bad results\n• Weal and woe: both good and bad results\n• Nothing: neutral results.",
		classes: ['Cleric'],
		ritual: true,
		tags: ['Utility'],
		isRareUse: true
	...
	},
	{
		...
		description:
			...
			'You attempt to suppress strong emotions in a group of people. Each humanoid in a 20 foot-radius sphere centered on a point you choose within range must make a Charisma saving throw. If a creature fails or chooses to fail its saving throw, choose one of the following two effects.\n• Suppress the charmed and frightened conditions.\n• Make the target indifferent about creatures of your choice that it is hostile toward. This indifference ends if the target is attacked or harmed by a spell or if it witnesses any of its friends being harmed.',
		classes: ['Bard', 'Cleric'],
	...
	},
	{
		...
		description:
			...
			'You plant four arrows in the ground and lay magic upon them to protect an area. Until the spell ends, whenever a creature (other than you & your allies) comes within 30 feet of the ammunition for the first time on a turn or ends its turn there, one piece of ammunition flies up to strike it. The creature must succeed on a Dexterity saving throw or take 1d6 piercing damage. The piece of ammunition is then destroyed.',
		classes: ['Ranger'],
	...
	},
	{
		...
		duration: 'Concentration, up to 1 minute',
		description:
			'One humanoid of your choice must succeed on a Wisdom saving throw or become charmed by you for the duration.\nWhile the target is charmed in this way, a twisted crown of jagged iron appears on its head, and a madness glows in its eyes.\nThe charmed target must use its action before moving on each of its turns to make a melee attack against a creature other than itself that you mentally choose. The target can act normally on its turn if you choose no creature or if none are within its reach.\nOn your subsequent turns, you must use your action to maintain control over the target, or the spell ends. The target can end this spell with a successful Wisdom saving throw at the end of one of its turns.',
		classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard'],
		tags: ['SpellSave', 'Debuff']
	},
	{
		...
		description:
			...
			"Magical darkness spreads from a point you choose within range to fill a 15 foot-radius sphere for the duration. A creature with darkvision can't see through this darkness, and nonmagical light can't illuminate it.\nIf the point you choose is on an object you are holding or one that isn't being worn or carried, the darkness emanates from the object and moves with it. Completely covering the source of the darkness with an opaque object, such as a bowl or a helm, blocks the darkness.",
		classes: ['Druid', 'Sorcerer', 'Warlock', 'Wizard'],
		tags: ['AreaOfEffect', 'Debuff', 'Utility']
	},
	{
	...
	},
	{
		...
		description:
			...
			'For the duration, you can read the thoughts of certain creatures. As an action, focus your mind on one creature within 30 feet. (the creature must speak a language and have an Intelligence of 4 or more)\nYou initially learn the surface thoughts of the creature. As an action, you may probe deeper into the creature’s mind. If so, the target must make a Wisdom saving throw. If it fails, you gain insight into its reasoning, its emotional state, or something that looms large in its mind (like a worry, love, or hate). If it succeeds, the spell ends. The target knows that you are probing into its mind and can make a contested Intelligence check to end the spell.',
		classes: ['Bard', 'Sorcerer', 'Wizard'],
	...
	},
	{
		...
		description:
			...
			"You cause a creature or an object to grow larger or smaller for the duration. If the target is unwilling, it can make a Constitution saving throw. \n[Enlarge]. The target's size doubles, and its weight is multiplied by eight. If there isn't enough room for the target to double its size, the creature or object attains the maximum possible size in the space available. Until the spell ends, the target also has advantage on Strength checks and Strength saving throws. The target's weapons also grow to match its new size, dealing 1d4 extra damage.\n[Reduce]. The target's size is halved in all dimensions, and its weight is reduced to one-eighth of normal. Until the spell ends, the target also has disadvantage on Strength checks and Strength saving throws. The target's weapons also shrink to match its new size, dealing 1d4 less damage (minimum of 1 damage).",
		classes: ['Sorcerer', 'Wizard'],
	...
	},
	{
		...
		description:
			...
			"You summon a spirit that assumes the form of an unusually intelligent, strong, and loyal steed. The steed takes on a form that you choose: a warhorse, a pony, a camel, an elk, or a mastiff.\nWhile mounted on your steed, you can make any spell you cast that targets only you also target your steed.\nWhen the steed drops to 0 hit points, it disappears, leaving behind no physical form. You can also dismiss your steed at any time as an action, causing it to disappear. In either case, casting this spell again summons the same steed, restored to its hit point maximum.\nWhile your steed is within 1 mile of you, you can communicate with each other telepathically.",
		classes: ['Paladin'],
		tags: ['Utility'],
		isRareUse: true
	},
	...
	},
	{
		...
		description:
			...
			'Choose a locked/blocked object such as a door, a box, or a chest.\nThe target becomes unlocked, unstuck, or unbarred. If the object has multiple locks, only one of them is unlocked.\nWhen you cast the spell, a loud knock, audible from as far away as 300 feet, emanates from the target object.',
		classes: ['Bard', 'Sorcerer', 'Wizard'],
		tags: ['Utility'],
		isRareUse: true
	},
	...
	},
	{
		...
		description:
			...
			"You implant a message within an object in range, a message that is uttered when a trigger condition is met. Speak a message of 25 words or less. Finally, determine the circumstance that will trigger the spell to deliver your message.\nWhen that circumstance occurs, a magical mouth appears on the object and recites the message in your voice and at the same volume you spoke.",
		classes: ['Bard', 'Wizard'],
		ritual: true,
		tags: ['Utility'],
		isRareUse: true
	...
	},
	{
		...
		description:
			...
			"Three illusory duplicates of yourself appear in your space. Until the spell ends, the duplicates move with you and mimic your actions, shifting position so it's impossible to track which image is real.\nEach time a creature targets you with an attack, roll a d20 to determine whether the attack instead targets one of your duplicates.\nYou must roll at least an 11, 8, or 6, depending on if you have 3, 2, or only 1 duplicate remaining.\nA duplicate's AC equals 10 + your Dexterity modifier. If an attack hits a duplicate, the duplicate is destroyed. A duplicate can be destroyed only by an attack that hits it. It ignores all other damage and effects. (such as Area of Effect spells, or spells that require a Saving Throw)",
		classes: ['Druid', 'Sorcerer', 'Warlock', 'Wizard'],
		tags: ['Buff']
	},
	{
	...
	},
	{
		...
		description:
			...
			'You place an illusion on a creature or an object you touch so that divination spells reveal false information about it. The target can be a willing creature or an object.\nWhen you cast the spell, choose one or both of the following effects.\n[False Aura]. You change the way the target appears to spells and magical effects. You can make a nonmagical object appear magical or a magical object appear nonmagical\n[Mask]. You change the way the target appears to spells and magical effects that detect creature types, such as a paladin’s Divine Sense. You choose a creature type and other spells and magical effects treat the target as if it were a creature of that type or of that alignment.',
		classes: ['Wizard'],
		tags: ['Utility'],
		isRareUse: true
	},
	...
	},
	{
		...
		duration: 'Concentration, up to 1 minute',
		description:
			//'You craft an illusion that takes root in the mind of a creature that you can see within range. The target must make an Intelligence saving throw. On a failed save, you create a phantasmal object, creature, or other visible phenomenon that is perceivable only to the target.\nThe phantasm includes sound, temperature, and other stimuli, also evident only to the creature.\nThe target can use its action to examine the phantasm with an Investigation check against your spell save DC. If the check succeeds, the target realizes that the phantasm is an illusion, and the spell ends.\nWhile a target is affected by the spell, the target treats the phantasm as if it were real. The target rationalizes any illogical outcomes from interacting with the phantasm. For example, a target attempting to walk across a phantasmal bridge that spans a chasm falls once it steps onto the bridge. If the target survives the fall, it still believes that the bridge exists and comes up with some other explanation for its fall - it was pushed, it slipped, or a strong wind might have knocked it off.\nAn affected target is so convinced of the phantasm’s reality that it can even take damage from the illusion. A phantasm created to appear as a creature can attack the target. Similarly, a phantasm created to appear as fire, a pool of acid, or lava can burn the target. Each round on your turn, the phantasm can deal 1d6 psychic damage to the target if it is in the phantasm’s area or within 5 feet of the phantasm, provided that the illusion is of a creature or hazard that could logically deal damage, such as by attacking. The target perceives the damage as a type appropriate to the illusion.',
			'You craft an illusion that takes root in the mind of a creature that you can see within range. The target must succeed an Intelligence saving throw, or be subjected to your phantasm (an object, creature, or other visible phenomenon) that only they can sense. This trick is so convincing that the target takes damage from the illusion; each round on your turn, the phantasm can deal 1d6 psychic damage if the target is within 5ft. of it. Your illusion can only deal damage if it could logically do so (as a beast, pool of lava, or floating sword might). The target may use their action to make an Investigation check against your spell save DC to see the illusion for what it is, ending the spell.',
		classes: ['Bard', 'Sorcerer', 'Wizard'],
		tags: ['SpellSave', 'Debuff']
	},
	{
