...
export const urchin: BackgroundData = {
	...
	backgroundFeatures: [
		...
		},
		{
			name: 'Equipment',
			id: 'urchin_equipment',
			description: 'You start with a small knife, city map, pet mouse, token from parents, common clothes, and 10 gp.',
			source: 'background:Urchin',
			effects: [
				{
					target: 'inventory',
		...
		},
		{
			name: 'City Secrets',
			id: 'urchin_feature',
			description: 'You know secret urban passages and can travel between city locations twice as fast as normal when not in combat.',
			source: 'background:Urchin',
			effects: [
				{
					target: 'features',
