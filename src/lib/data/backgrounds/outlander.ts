...
export const outlander: BackgroundData = {
	...
	flavorDescription: 'You\'ve witnessed the migration of herds larger than forests, survived weather more extreme than any city-dweller could comprehend, and enjoyed the solitude of being the only thinking creature for miles in any direction.',
	...
	backgroundFeatures: [
		...
		},
		{
			...
			description: 'You have excellent memory for geography and can find food and shelter for yourself and up to five others each day in the wilderness.',
			source: 'background:Outlander',
			effects: [
				{
					target: 'features',
