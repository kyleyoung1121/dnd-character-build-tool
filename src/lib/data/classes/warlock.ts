...
const proficienciesPrompt: FeaturePrompt = {
	...
	description: {
		blocks: [
			...
			{ type: 'text', text: 'Weapons: Simple weapons' },
			{ type: 'text', text: 'Saving Throws: Wisdom, Charisma' },
			{ type: 'text', text: 'Skills: Choose two from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion' },
		]
	},
	featureOptions: {
				...
				nestedPrompts: [
					{
						...
						description: {
							blocks: [
								{ type: 'text', text: 'The Archfey lets you choose from an expanded list of spells when you learn a warlock spell. The following spells are added to the warlock spell list for you:' },
								{ type: 'text', text: '1st Level: Faerie Fire, Sleep' },
								{ type: 'text', text: '2nd Level: Calm Emotions, Phantasmal Force' },
							]
						},
				...
				nestedPrompts: [
					{
						...
						description: {
							blocks: [
								{ type: 'text', text: 'The Fiend lets you choose from an expanded list of spells when you learn a warlock spell. The following spells are added to the warlock spell list for you:' },
								{ type: 'text', text: '1st Level: Burning Hands, Command' },
								{ type: 'text', text: '2nd Level: Blindness/Deafness, Scorching Ray' },
							]
						},
				...
				nestedPrompts: [
					{
						...
						name: 'Pact of the Chain Description',
						description: {
							blocks: [
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can cast Mage Armor on yourself at will, without expending a spell slot or material components.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can cast Speak with Animals at will, without expending a spell slot.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You gain proficiency in the Deception and Persuasion skills.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: [
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can see normally in darkness, both magical and nonmagical, to a distance of 120 feet.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can cast Detect Magic at will, without expending a spell slot.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can read all writing.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can cast False Life on yourself at will as a 1st-level spell, without expending a spell slot or material components.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can cast Disguise Self at will, without expending a spell slot.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
									...
									nestedPrompts: [
										{
											...
											description: {
												blocks: [
													{ type: 'text', text: 'You can cast Silent Image at will, without expending a spell slot or material components.' },
												]
											},
											source: 'warlock.eldritch_invocations',
											effects: []
				...
				nestedPrompts: [
					{
						...
						description: {
							blocks: [
								{ type: 'text', text: 'You can use your action to create a pact weapon in your empty hand. You can choose the form that this melee weapon takes each time you create it. You are proficient with it while you wield it. This weapon counts as magical for the purpose of overcoming resistance and immunity to nonmagical attacks and damage. Your pact weapon disappears if it is more than 5 feet away from you for 1 minute or more. It also disappears if you use this feature again, if you dismiss the weapon (no action required), or if you die. You can transform one magic weapon into your pact weapon by performing a special ritual while you hold the weapon. You perform the ritual over the course of 1 hour, which can be done during a short rest.' },
							]
						},
						source: 'warlock.pact_boon',
						effects: [
				...
				nestedPrompts: [
					{
						...
						name: 'Pact of the Tome Description',
						description: {
							blocks: [
